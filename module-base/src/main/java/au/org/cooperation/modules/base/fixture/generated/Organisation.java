 ...
 *         &lt;element name="orgperson" maxOccurs="unbounded" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
...
public class Organisation {
    ...
    protected List<Organisation.Orgperson> orgperson;
    ...
    /**
     * Gets the value of the orgperson property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orgperson property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrgperson().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Organisation.Orgperson }
     * 
     * 
     */
    public List<Organisation.Orgperson> getOrgperson() {
        if (orgperson == null) {
            orgperson = new ArrayList<Organisation.Orgperson>();
        }
